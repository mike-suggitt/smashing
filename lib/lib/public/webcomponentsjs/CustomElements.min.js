...
"undefined" == typeof WeakMap && !function () {
  ...
  function t(e) {
    ...
    var w,
        v = new WeakMap();if (/Trident|Edge/.test(navigator.userAgent)) w = setTimeout;else if (window.setImmediate) w = window.setImmediate;else {
      var h = [],
      ...
      } };var y, N;m.prototype = { enqueue: function enqueue(e) {
        ...
        switch (e.stopImmediatePropagation(), e.type) {case "DOMAttrModified":
            ...
            var d,
                ...
                m = f.nextSibling,
                r = u("childList", e.target.parentNode);r.addedNodes = d, r.removedNodes = s, r.previousSibling = p, r.nextSibling = m, i(e.relatedNode, function (e) {
  ...
  function t(e, t) {
    ...
    if (e = window.wrap(e), !(n.indexOf(e) >= 0)) {
      n.push(e);for (var o, r = e.querySelectorAll("link[rel=" + a + "]"), d = 0, s = r.length; s > d && (o = r[d]); d++) {
  ...
  function t(e, t) {
    ...
    y = !1;for (var e, t = N, n = 0, o = t.length; o > n && (e = t[n]); n++) {
      e();
    }N = [];
  }function a(e) {
    _ ? r(function () {
    ...
    e = window.wrap(e), g.dom && console.group("upgradeDocument: ", e.baseURI.split("/").pop());var n = e === window.wrap(document);t(e, n), w(e), g.dom && console.groupEnd();
  }function h(e) {
    E(e, v);
  }var g = e.flags,
      b = e.forSubtree,
  ...
  function t(t, o) {
    ...
    var n = e[t];e[t] = function () {
      ...
      O = document.createElementNS.bind(document);w = Object.__proto__ || E ? function (e, t) {
