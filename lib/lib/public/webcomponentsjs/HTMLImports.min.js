...
"undefined" == typeof WeakMap && !function () {
  ...
  function t(e, t) {
    ...
    function n() {
      ...
      l.push(this), d++, n();
        ...
        c = s.length,
        u = [],
        l = [];if (c) for (var h, m = 0; c > m && (h = s[m]); m++) {
  ...
  var t = e.xhr,
    ...
    this.cache = {}, this.onload = e, this.oncomplete = t, this.inflight = 0, this.pending = {};
      ...
      this.cache[e] = r;for (var i, a = this.pending[e], s = 0, d = a.length; d > s && (i = a[s]); s++) {
    ...
    var t = e.ownerDocument.createElement("style");return t.textContent = e.textContent, a.resolveUrlsInStyle(t), t;
      ...
      var n = this,
        ...
        var o = !1;if (-1 == e.textContent.indexOf("@import")) o = !0;else if (e.sheet) {
          o = !0;for (var i, a = e.sheet.cssRules, s = a ? a.length : 0, d = 0; s > d && (i = a[d]); d++) {
