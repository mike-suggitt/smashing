...
"undefined" == typeof WeakMap && !function () {
  ...
  function t() {
    ...
    var n = e.__proto__ || Object.getPrototypeOf(e);if (U) try {
      k(n);
    } catch (r) {
      n = n.__proto__;
    ...
    for (var i = k(t), a = 0; a < i.length; a++) {
      var s = i[a];if ("polymerBlackList_" !== s && !(s in n || t.polymerBlackList_ && t.polymerBlackList_[s])) {
        U && t.__lookupGetter__(s);var c,
            u,
            p = w(t, s);if ("function" != typeof p.value) {
          var m = l(s);c = m ? e.getEventHandlerGetter(s) : d(s), (p.writable || p.set || V) && (u = m ? e.getEventHandlerSetter(s) : f(s));var v = V || p.configurable;A(n, s, { get: c, set: u, configurable: v, enumerable: p.enumerable });
        } else r && (n[s] = h(s));
      }
    }
  }function v(e, t, n) {
    ...
    var o = t.prototype;n(void 0 === R.get(e)), R.set(e, t), P.set(o, e), c(e, o), r && u(o, r), a(o, "constructor", t), t.prototype = o;
  }function b(e, t) {
    ...
    if (null === e) return null;n(M(e));var t = e.__wrapper8e3dd93a60__;return null != t ? t : e.__wrapper8e3dd93a60__ = new (s(e, e))(e);
  }function O(e) {
    ...
    e.forEach(function (e) {
      t.forEach(function (t) {
        e.prototype[t] = function () {
          var e = _(this);return e[t].apply(e, arguments);
        };
      });
    });
  }var R = new WeakMap(),
      ...
      B = { value: void 0, configurable: !0, enumerable: !1, writable: !0 };k(window);var U = /Firefox/.test(navigator.userAgent),
      q = { get: function get() {}, set: function set(e) {}, configurable: !0, enumerable: !0 },
      V = function () {
  ...
  function t(e, t, n) {
    return { index: e, removed: t, addedCount: n };
        ...
        if (0 != t) {
          if (0 != n) {
            var u,
                l = e[t - 1][n - 1],
                p = e[t - 1][n],
                d = e[t][n - 1];u = d > p ? l > p ? p : l : l > d ? d : l, u == l ? (l == s ? c.push(r) : (c.push(o), s = l), t--, n--) : u == p ? (c.push(a), t--, s = p) : (c.push(i), n--, s = d);
          } else c.push(a), t--;
        } else c.push(i), n--;
      }return c.reverse(), c;
      ...
      var p = 0,
          d = 0,
          f = Math.min(s - n, l - u);if (0 == n && 0 == u && (p = this.sharedPrefix(e, c, f)), s == e.length && l == c.length && (d = this.sharedSuffix(e, c, f - p)), n += p, u += p, s -= d, l -= d, s - n == 0 && l - u == 0) return [];if (n == s) {
        for (var h = t(n, [], 0); l > u;) {
          h.removed.push(c[u++]);
        }return [h];
      }if (u == l) return [t(n, [], s - n)];for (var w = this.spliceOperationsFromEditDistances(this.calcEditDistances(e, n, s, c, u, l)), h = void 0, m = [], v = n, g = u, b = 0; b < w.length; b++) {
        switch (w[b]) {case r:
            h && (m.push(h), h = void 0), v++, g++;break;case o:
            h || (h = t(v, [], 0)), h.addedCount++, v++, h.removed.push(c[g]), g++;break;case i:
            h || (h = t(v, [], 0)), h.addedCount++, v++;break;case a:
  ...
  function t() {
    ...
    var s = 1,
        c = new o(t),
        u = document.createTextNode(s);c.observe(u, { characterData: !0 }), r = function r() {
      s = (s + 1) % 2, u.data = s;
    };
  ...
  function t(e) {
    ...
    for (; e; e = e.parentNode) {
      var n = f.get(e);if (n) for (var r = 0; r < n.length; r++) {
    ...
    for (var t = 0; t < e.nodes_.length; t++) {
      var n = e.nodes_[t],
          r = f.get(n);if (!r) return;for (var o = 0; o < r.length; o++) {
        var i = r[o];i.observer === e && i.removeTransientObservers();
      }
    }
  }function a(e, n, o) {
    for (var i = Object.create(null), a = Object.create(null), s = e; s; s = s.parentNode) {
      var c = f.get(s);if (c) for (var u = 0; u < c.length; u++) {
        var l = c[u],
            p = l.options;if ((s === e || p.subtree) && ("attributes" !== n || p.attributes) && ("attributes" !== n || !p.attributeFilter || null === o.namespace && -1 !== p.attributeFilter.indexOf(o.name)) && ("characterData" !== n || p.characterData) && ("childList" !== n || p.childList)) {
          var d = l.observer;i[d.uid_] = d, ("attributes" === n && p.attributeOldValue || "characterData" === n && p.characterDataOldValue) && (a[d.uid_] = o.oldValue);
        }
      }
    }for (var h in i) {
      var d = i[h],
          w = new r(n, e);"name" in o && "namespace" in o && (w.attributeName = o.name, w.attributeNamespace = o.namespace), o.addedNodes && (w.addedNodes = o.addedNodes), o.removedNodes && (w.removedNodes = o.removedNodes), o.previousSibling && (w.previousSibling = o.previousSibling), o.nextSibling && (w.nextSibling = o.nextSibling), void 0 !== a[h] && (w.oldValue = a[h]), t(d), d.records_.push(w);
    }
  }function s(e) {
    if (this.childList = !!e.childList, this.subtree = !!e.subtree, "attributes" in e || !("attributeOldValue" in e || "attributeFilter" in e) ? this.attributes = !!e.attributes : this.attributes = !0, "characterDataOldValue" in e && !("characterData" in e) ? this.characterData = !0 : this.characterData = !!e.characterData, !this.attributes && (e.attributeOldValue || "attributeFilter" in e) || !this.characterData && e.characterDataOldValue) throw new TypeError();if (this.characterData = !!e.characterData, this.attributeOldValue = !!e.attributeOldValue, this.characterDataOldValue = !!e.characterDataOldValue, "attributeFilter" in e) {
      if (null == e.attributeFilter || "object" != _typeof(e.attributeFilter)) throw new TypeError();this.attributeFilter = m.call(e.attributeFilter);
    ...
    this.observer = e, this.target = t, this.options = n, this.transientObservedNodes = [];
      ...
      e = p(e);var n,
          r = new s(t),
          o = f.get(e);o || f.set(e, o = []);for (var i = 0; i < o.length; i++) {
    ...
    } }, u.prototype = { addTransientObserver: function addTransientObserver(e) {
      if (e !== this.target) {
        t(this.observer), this.transientObservedNodes.push(e);var n = f.get(e);n || f.set(e, n = []), n.push(this);
      }
  ...
  function t(e) {
    ...
    var s = [],
        c = e;for (s.push(c); c;) {
      var u = a(c);if (u && u.length > 0) {
        for (var l = 0; l < u.length; l++) {
          var d = u[l];if (i(d)) {
            var f = n(d),
                h = f.olderShadowRoot;h && s.push(h);
          }s.push(d);
        }c = u[u.length - 1];
      } else if (t(c)) {
        if (p(e, c) && o(r)) break;c = c.host, s.push(c);
    ...
    if (0 === e.length) return t;t instanceof G.Window && (t = t.document);for (var n = A(t), r = e[0], o = A(r), i = u(n, o), a = 0; a < e.length; a++) {
    ...
    t instanceof G.Window && (t = t.document);var o,
        ...
        a = A(n),
        s = r(n, e),
        o = u(i, a);o || (o = a.root);for (var c = o; c; c = c.parent) {
      for (var l = 0; l < s.length; l++) {
        var p = s[l];if (A(p) === c) return p;
      }
    }return null;
  }function p(e, t) {
    return A(e) === A(t);
    ...
    if (!X.get(e) && (X.set(e, !0), h(V(e), V(e.target)), W)) {
      var t = W;throw W = null, t;
    }
  }function f(e) {
    switch (e.type) {case "load":case "beforeunload":case "unload":
        return !0;}return !1;
  }function h(t, n) {
    if (K.get(t)) throw new Error("InvalidStateError");K.set(t, !0), e.renderAllPending();var o, i, a;if (f(t) && !t.bubbles) {
    ...
    var i = z.get(e);if (!i) return !0;var a = o || s(r, e);if (a === e) {
      ...
      var c = q(t),
          u = c.relatedTarget;if (u) {
        if (u instanceof Object && u.addEventListener) {
          var p = V(u),
              d = l(t, e, p);if (d === a) return !0;
        } else d = null;Z.set(t, d);
      }
    }J.set(t, n);var f = t.type,
        h = !1;Y.set(t, a), $.set(t, e), i.depth++;for (var w = 0, m = i.length; m > w; w++) {
      var v = i[w];if (v.removed) h = !0;else if (!(v.type !== f || !v.capture && n === oe || v.capture && n === ae)) try {
        if ("function" == typeof v.handler ? v.handler.call(e, t) : v.handler.handleEvent(t), ee.get(t)) return !1;
      } catch (g) {
        W || (W = g);
      }
    }if (i.depth--, h && 0 === i.depth) {
      var b = i.slice();i.length = 0;for (var w = 0; w < b.length; w++) {
    ...
    if (!(e instanceof se)) return V(T(se, "Event", e, t));var n = e;return be || "beforeunload" !== n.type || this instanceof O ? void B(n, this) : new O(n);
  }function E(e) {
    ...
    return function () {
      arguments[t] = q(arguments[t]);var n = q(this);n[e].apply(n, arguments);
    };
  }function T(e, t, n, r) {
    if (ve) return new e(n, E(r));var o = q(document.createEvent(t)),
        i = me[t],
        a = [n];return Object.keys(i).forEach(function (e) {
      var t = null != r && e in r ? r[e] : i[e];"relatedTarget" === e && (t = q(t)), a.push(t);
    ...
    e.renderAllPending();var a = V(Se.call(U(n), o, i));if (!a) return null;var c = r(a, null),
        u = c.lastIndexOf(t);return -1 == u ? null : (c = c.slice(0, u), s(c, t));
  }function R(e) {
    return function () {
    ...
    this.cancelable && (U(this).preventDefault(), Object.defineProperty(this, "defaultPrevented", { get: function get() {
        return !0;
      }, configurable: !0 }));
  }), F(se, y, document.createEvent("Event"));var ue = S("UIEvent", y),
      le = S("CustomEvent", y),
      pe = { get relatedTarget() {
      var e = Z.get(this);return void 0 !== e ? e : V(q(this).relatedTarget);
    } },
  ...
  }var be = window.BeforeUnloadEvent;O.prototype = Object.create(y.prototype), k(O.prototype, { get returnValue() {
      return U(this).returnValue;
    }, set returnValue(e) {
      U(this).returnValue = e;
    } }), be && F(be, O);var ye = window.EventTarget,
    ...
    var t = e.prototype;Ee.forEach(function (e) {
  ...
  }), L.prototype = { addEventListener: function addEventListener(e, t, n) {
      if (N(t) && !j(e)) {
        var r = new b(e, t, n),
            o = z.get(this);if (o) {
        ...
        } else o = [], o.depth = 0, z.set(this, o);o.push(r);var a = _(this);a.addEventListener_(e, d, !0);
      }
      ...
      n = Boolean(n);var r = z.get(this);if (r) {
        for (var o = 0, i = !1, a = 0; a < r.length; a++) {
          ...
          var s = _(this);s.removeEventListener_(e, d, !0);
        }
      }
    }, dispatchEvent: function dispatchEvent(t) {
      var n = q(t),
          r = n.type;X.set(n, !1), e.renderAllPending();var o;C(this, r) || (o = function o() {}, this.addEventListener(r, o, !0));try {
        return q(this).dispatchEvent_(n);
      } finally {
        o && this.removeEventListener(r, o, !0);
      }
    } }, ye && F(ye, L);var Se = document.elementFromPoint;e.elementFromPoint = x, e.getEventHandlerGetter = R, e.getEventHandlerSetter = P, e.wrapEventTargetMethods = H, e.wrappers.BeforeUnloadEvent = O, e.wrappers.CustomEvent = le, e.wrappers.Event = y, e.wrappers.EventTarget = L, e.wrappers.FocusEvent = we, e.wrappers.MouseEvent = he, e.wrappers.UIEvent = ue;
}(window.ShadowDOMPolyfill), function (e) {
  "use strict";
  function t(e, t) {
    ...
    a.call(this, e);
      ...
      l = e.unsafeUnwrap,
      p = e.wrap,
      d = window.TouchEvent;if (d) {
    var f;try {
      f = document.createEvent("TouchEvent");
    } catch (h) {
      return;
    }var w = { enumerable: !1 };n.prototype = { get target() {
        return p(l(this).target);
      } };var m = { configurable: !0, enumerable: !0, get: null };["clientX", "clientY", "screenX", "screenY", "pageX", "pageY", "identifier", "webkitRadiusX", "webkitRadiusY", "webkitRotationAngle", "webkitForce"].forEach(function (e) {
      m.get = function () {
        return l(this)[e];
  ...
  function t(e) {
    ...
    if (e instanceof DocumentFragment) {
      var i = s(e);B = !0;for (var a = i.length - 1; a >= 0; a--) {
        e.removeChild(i[a]), i[a].parentNode_ = t;
      }B = !1;for (var a = 0; a < i.length; a++) {
    ...
    var n = e.nodeType === S.DOCUMENT_NODE ? e : e.ownerDocument;n !== t.ownerDocument && n.adoptNode(t);
  }function h(t, n) {
    if (n.length) {
    ...
    h(e, t);var n = t.length;if (1 === n) return W(t[0]);for (var r = W(e.ownerDocument.createDocumentFragment()), o = 0; n > o; o++) {
      r.appendChild(W(t[o]));
    }return r;
  }function m(e) {
    ...
    if (e.invalidateShadowRenderer()) {
      for (var t = e.firstChild; t;) {
        N(t.parentNode === e);var n = t.nextSibling,
            r = W(t),
            o = r.parentNode;o && Y.call(o, r), t.previousSibling_ = t.nextSibling_ = t.parentNode_ = null, t = n;
    ...
    var r;if (r = A(n ? U.call(n, P(e), !1) : q.call(P(e), !1)), t) {
      for (var o = e.firstChild; o; o = o.nextSibling) {
    ...
    if (!t || _(e) !== _(t)) return !1;for (var n = t; n; n = n.parentNode) {
      if (n === e) return !0;
    }return !1;
  }function S(e) {
    ...
    Y.call(e, t);
  };S.prototype = Object.create(M.prototype), C(S.prototype, { appendChild: function appendChild(e) {
      return this.insertBefore(e, null);
    }, insertBefore: function insertBefore(e, n) {
      t(e);var r;n ? D(n) ? r = W(n) : (r = n, n = A(r)) : (n = null, r = null), n && N(n.parentNode === this);var o,
          s = n ? n.previousSibling : this.lastChild,
          c = !this.invalidateShadowRenderer() && !g(e);if (o = c ? a(e) : i(e, this, s, n), c) f(this, e), m(this), K.call(P(this), W(e), r);else {
        s || (this.firstChild_ = o[0]), n || (this.lastChild_ = o[o.length - 1], void 0 === this.firstChild_ && (this.firstChild_ = this.firstChild));var u = r ? r.parentNode : P(this);u ? K.call(u, w(this, o), r) : h(this, o);
      ...
      if (t(e), e.parentNode !== this) {
        ...
        var c = this.firstChild,
            u = this.lastChild,
            l = i.parentNode;l && J(l, i), c === e && (this.firstChild_ = a), u === e && (this.lastChild_ = s), s && (s.nextSibling_ = a), a && (a.previousSibling_ = s), e.previousSibling_ = e.nextSibling_ = e.parentNode_ = void 0;
      } else m(this), J(P(this), i);return B || L(this, "childList", { removedNodes: n(e), nextSibling: a, previousSibling: s }), H(this, e), e;
    }, replaceChild: function replaceChild(e, r) {
      t(e);var o;if (D(r) ? o = W(r) : (o = r, r = A(o)), r.parentNode !== this) throw new Error("NotFoundError");var s,
          c = r.nextSibling,
          u = r.previousSibling,
          d = !this.invalidateShadowRenderer() && !g(e);return d ? s = a(e) : (c === e && (c = e.nextSibling), s = i(e, this, u, c)), d ? (f(this, e), m(this), $.call(P(this), W(e), o)) : (this.firstChild === r && (this.firstChild_ = s[0]), this.lastChild === r && (this.lastChild_ = s[s.length - 1]), r.previousSibling_ = r.nextSibling_ = r.parentNode_ = void 0, o.parentNode && $.call(o.parentNode, w(this, s), o)), L(this, "childList", { addedNodes: s, removedNodes: n(r), nextSibling: c, previousSibling: u }), p(r), l(s, this), r;
      ...
      null == e && (e = "");var t = c(this.childNodes);if (this.invalidateShadowRenderer()) {
        if (v(this), "" !== e) {
          var n = P(this).ownerDocument.createTextNode(e);this.appendChild(n);
        }
      } else m(this), P(this).textContent = e;var r = c(this.childNodes);L(this, "childList", { addedNodes: r, removedNodes: t }), d(t), l(r, this);
    }, get childNodes() {
  ...
  function t(t, n, r, o) {
    ...
    var r = e.localName;return r === t || r === n && e.namespaceURI === D;
  }function s() {
    return !0;
  }function c(e, t, n) {
    ...
    var s,
        c = g(this),
        u = v(this).root;if (u instanceof e.wrappers.ShadowRoot) return p(this, r, o, n, i, null);if (c instanceof L) s = M.call(c, i);else {
      if (!(c instanceof _)) return p(this, r, o, n, i, null);s = S.call(c, i);
    }return t(s, r, o, a);
  }function f(n, r, o, i, a) {
    var s,
        c = g(this),
        u = v(this).root;if (u instanceof e.wrappers.ShadowRoot) return p(this, r, o, n, i, a);if (c instanceof L) s = O.call(c, i, a);else {
      if (!(c instanceof _)) return p(this, r, o, n, i, a);s = T.call(c, i, a);
    }return t(s, r, o, !1);
  }function h(n, r, o, i, a) {
    var s,
        c = g(this),
        u = v(this).root;if (u instanceof e.wrappers.ShadowRoot) return p(this, r, o, n, i, a);if (c instanceof L) s = j.call(c, i, a);else {
      if (!(c instanceof _)) return p(this, r, o, n, i, a);s = N.call(c, i, a);
    }return t(s, r, o, !1);
      ...
      C = { querySelector: function querySelector(t) {
      var r = n(t),
          i = r !== t;t = r;var a,
          s = g(this),
          c = v(this).root;if (c instanceof e.wrappers.ShadowRoot) return o(this, t);if (s instanceof L) a = b(E.call(s, t));else {
        if (!(s instanceof _)) return o(this, t);a = b(y.call(s, t));
      }return a && !i && (c = v(a).root) && c instanceof e.wrappers.ShadowRoot ? o(this, t) : a;
    }, querySelectorAll: function querySelectorAll(e) {
      var t = n(e),
          r = t !== e;e = t;var o = new m();return o.length = d.call(this, i, 0, o, e, r), o;
    } },
      ...
      var t = new w(),
          n = "*" === e ? s : a;return t.length = f.call(this, n, 0, t, e, e.toLowerCase()), t;
    }, getElementsByClassName: function getElementsByClassName(e) {
      return this.querySelectorAll("." + e);
    }, getElementsByTagNameNS: function getElementsByTagNameNS(e, t) {
      var n = new w(),
          r = null;return r = "*" === e ? "*" === t ? s : c : "*" === t ? u : l, n.length = h.call(this, r, 0, n, e || null, t), n;
  ...
  function t(e) {
    ...
    o(this, c, arguments);
  };var u = DOMTokenList.prototype.toggle;DOMTokenList.prototype.toggle = function () {
  ...
  function t(t, n) {
    ...
    return w.prototype[e];
      ...
      v = m[0],
      g = w.prototype[v],
      b = new WeakMap();r.prototype = Object.create(a.prototype), p(r.prototype, { createShadowRoot: function createShadowRoot() {
      var t = new h.ShadowRoot(this);f(this).polymerShadowRoot_ = t;var n = e.getRendererForHost(this);return n.invalidate(), t;
    }, get shadowRoot() {
      return f(this).polymerShadowRoot_ || null;
    }, setAttribute: function setAttribute(e, r) {
      var o = f(this).getAttribute(e);f(this).setAttribute(e, r), n(this, e, o), t(this, e);
    }, removeAttribute: function removeAttribute(e) {
      var r = f(this).getAttribute(e);f(this).removeAttribute(e), n(this, e, r), t(this, e);
    }, get classList() {
      var e = b.get(this);if (!e) {
        if (e = f(this).classList, !e) return;e.ownerElement_ = this, b.set(this, e);
      }return e;
    }, get className() {
  ...
  function t(e) {
    ...
    if (e.namespaceURI !== C) return !0;var t = e.ownerDocument.doctype;return t && t.publicId && t.systemId;
  }function a(e, t) {
    switch (e.nodeType) {case Node.ELEMENT_NODE:
        for (var o, a = e.tagName.toLowerCase(), c = "<" + a, u = e.attributes, l = 0; o = u[l]; l++) {
          c += " " + o.name + '="' + n(o.value) + '"';
        }return _[a] ? (i(e) && (c += "/"), c + ">") : c + ">" + s(e) + "</" + a + ">";case Node.TEXT_NODE:
        var p = e.data;return t && D[t.localName] ? p : r(p);case Node.COMMENT_NODE:
        return "<!--" + e.data + "-->";default:
        throw console.error(e), new Error("not implemented");}
  }function s(e) {
    e instanceof N.HTMLTemplateElement && (e = e.content);for (var t = "", n = e.firstChild; n; n = n.nextSibling) {
      t += a(n, e);
    }return t;
  }function c(e, t, n) {
    ...
    Object.defineProperty(u.prototype, t, { get: p(t), set: function set(n) {
        e.renderAllPending(), M(this)[t] = n;
      }, configurable: !0, enumerable: !0 });
  }function h(t) {
    Object.defineProperty(u.prototype, t, { value: function value() {
      ...
      var n, r;switch (String(e).toLowerCase()) {case "beforebegin":
          ...
          return;}var o = l(n, t);n.insertBefore(o, r);
    }, get hidden() {
  ...
  "use strict";
  function t(e) {
    if (!e.defaultView) return e;var t = p.get(e);if (!t) {
    ...
    if (o.call(this, e), !d) {
      ...
      l = new WeakMap(),
      p = new WeakMap(),
      d = window.HTMLTemplateElement;r.prototype = Object.create(o.prototype), i(r.prototype, { constructor: r, get content() {
  ...
  function t(e) {
    ...
    if (!(this instanceof r)) throw new TypeError("DOM object constructor cannot be called as a function.");var a = c(document.createElement("option"));o.call(this, a), s(a, this), void 0 !== e && (a.text = e), void 0 !== t && a.setAttribute("value", t), n === !0 && a.setAttribute("selected", ""), a.selected = i === !0;
      ...
      c = e.unwrap,
      u = e.wrap,
      l = window.HTMLOptionElement;n.prototype = Object.create(o.prototype), i(n.prototype, { get text() {
  ...
  function t(e) {
    n.call(this, e);
      ...
      u = window.SVGElement,
      l = document.createElementNS(c, "title");if (!("classList" in l)) {
    var p = Object.getOwnPropertyDescriptor(n.prototype, "classList");Object.defineProperty(r.prototype, "classList", p), delete n.prototype.classList;
  ...
  function t(e) {
    d.call(this, e);
      ...
      d = p.constructor;t.prototype = Object.create(p), "instanceRoot" in u && n(t.prototype, { get instanceRoot() {
  ...
  function t(e) {
    o(e, this);
      ...
      s = e.unwrapIfNeeded,
      c = e.wrap,
      u = window.CanvasRenderingContext2D;n(t.prototype, { get canvas() {
  ...
  function t(e) {
    i(e, this);
      ...
      s = e.unwrapIfNeeded,
      c = e.wrap,
      u = window.WebGLRenderingContext;if (u) {
    r(t.prototype, { get canvas() {
      ...
      } });var l = Object.getPrototypeOf(u.prototype);l !== Object.prototype && n(l, t.prototype);var p = /WebKit/.test(navigator.userAgent) ? { drawingBufferHeight: null, drawingBufferWidth: null } : {};o(u, t, p), e.wrappers.WebGLRenderingContext = t;
  }
}(window.ShadowDOMPolyfill), function (e) {
  "use strict";
  function t(e) {
    n.call(this, e);
      ...
      c = e.registerObject,
      u = e.registerWrapper,
      l = window.DocumentFragment;t.prototype = Object.create(n.prototype), s(t.prototype, i), s(t.prototype, a), s(t.prototype, r), s(t.prototype, o), u(l, t, document.createDocumentFragment()), e.wrappers.DocumentFragment = t;var p = c(document.createComment(""));e.wrappers.Comment = p;
}(window.ShadowDOMPolyfill), function (e) {
  "use strict";
  function t(e) {
    var t = p(l(e).ownerDocument.createDocumentFragment());n.call(this, t), c(t, this);var o = e.shadowRoot;h.set(this, o), this.treeScope_ = new r(this, a(o || e)), f.set(this, e);
      ...
      d = e.wrap,
      f = new WeakMap(),
      h = new WeakMap();t.prototype = Object.create(n.prototype), s(t.prototype, { constructor: t, get innerHTML() {
      return i(this);
    }, set innerHTML(e) {
      ...
      var e = p(this).ownerDocument.activeElement;if (!e || !e.nodeType) return null;for (var t = d(e); !this.contains(t);) {
        for (; t.parentNode;) {
          t = t.parentNode;
  ...
  "use strict";
  function t(e) {
    var t = p(e).root;return t instanceof f ? t.host : null;
  }function n(t, n) {
    if (t.shadowRoot) {
    ...
    a(e, this);
      ...
      p = e.getTreeScope,
      d = window.Range,
      f = e.wrappers.ShadowRoot;o.prototype = { get startContainer() {
  ...
  function t(e) {
    ...
    var a = x(n),
      ...
      n.lastChild_ = n.lastChild, n.lastChild === n.firstChild && (n.firstChild_ = n.firstChild);var u = R(a.lastChild);u && (u.nextSibling_ = u.nextSibling);
    ...
    var t = W.get(e);return t || W.set(e, t = []), t;
  }function a(e) {
    ...
    var t = A.get(e);return t || (t = new f(e), A.set(e, t)), t;
  }function l(e) {
    var t = D(e).root;return t instanceof _ ? t : null;
  }function p(e) {
    return u(e.host);
  }function d(e) {
    ...
    if (e instanceof j) return e;if (e instanceof N) return null;for (var t = e.firstChild; t; t = t.nextSibling) {
      var n = w(t);if (n) return n;
    }return null;
  }function m(e, t) {
    i(t).push(e);var n = I.get(e);n ? n.push(t) : I.set(e, [t]);
  }function v(e) {
    return I.get(e);
  }function g(e) {
    I.set(e, void 0);
  }function b(e, t) {
    var n = t.getAttribute("select");if (!n) return !0;if (n = n.trim(), !n) return !0;if (!(e instanceof O)) return !1;if (!U.test(n)) return !1;try {
      return e.matches(n);
    } catch (r) {
      return !1;
    }
    ...
    for (var t = [], n = e.shadowRoot; n; n = n.olderShadowRoot) {
      ...
      F = [],
      B = new P();B.equals = function (e, t) {
    return x(e.node) === t;
  }, d.prototype = { append: function append(e) {
      var t = new d(e);return this.childNodes.push(t), t;
      ...
      if (!this.skip) {
        for (var t = this.node, o = this.childNodes, i = a(x(t)), s = e || new WeakMap(), c = B.calculateSplices(o, i), u = 0, l = 0, p = 0, d = 0; d < c.length; d++) {
          for (var f = c[d]; p < f.index; p++) {
            ...
            var m = R(i[l++]);s.get(m) || r(m);
          }for (var v = f.addedCount, g = i[l] && R(i[l]), w = 0; v > w; w++) {
            var b = o[u++],
    ...
    } }, f.prototype = { render: function render(e) {
      if (this.dirty) {
        this.invalidateAttributes();var t = this.host;this.distribution(t);var n = e || new d(t);this.buildRenderTree(n, t);var r = !e;r && n.sync(), this.dirty = !1;
      }
    }, get parentRenderer() {
      return D(this.host).renderer;
    }, invalidate: function invalidate() {
      if (!this.dirty) {
        this.dirty = !0;var e = this.parentRenderer;if (e && e.invalidate(), F.push(this), T) return;T = window[k](c, 0);
      }
      ...
      if (S(e)) {
        for (var t = e, n = h(t), r = M(t), o = 0; o < r.length; o++) {
          ...
          var i = r[o],
              a = w(i);if (a) {
            var s = i.olderShadowRoot;s && (n = h(s));for (var c = 0; c < n.length; c++) {
              m(n[c], a);
            }
      ...
      if (!(e instanceof j)) if (e instanceof N) {
        var n = e;this.updateDependentAttributes(n.getAttribute("select"));for (var r = !1, o = 0; o < t.length; o++) {
          var e = t[o];e && b(e, n) && (m(e, n), t[o] = void 0, r = !0);
    ...
    } };var U = /^(:not\()?[*.#[a-zA-Z_|]/;L.prototype.invalidateShadowRenderer = function (e) {
    ...
    this.invalidateShadowRenderer();var e,
        t = l(this);t && (e = p(t)), H(this).polymerShadowRenderer_ = e, e && e.invalidate();
  }, e.getRendererForHost = u, e.getShadowTrees = M, e.renderAllPending = s, e.getDestinationInsertionPoints = v, e.visual = { insertBefore: n, remove: r };
}(window.ShadowDOMPolyfill), function (e) {
  "use strict";
  function t(t) {
    if (window[t]) {
  ...
  function t(e) {
    ...
    e.shadowRoot && t.adoptNode(e.shadowRoot), e instanceof w && i(e, t);for (var n = e.firstChild; n; n = n.nextSibling) {
      o(n, t);
    }
  }function i(e, t) {
    ...
    var n = document.implementation[t];e.prototype[t] = function () {
      ...
      H = (e.wrapNodeList, new WeakMap());t.prototype = Object.create(l.prototype), b(t, "documentElement"), b(t, "body"), b(t, "head"), g(t, "activeElement", function () {
    var e = _(this).activeElement;if (!e || !e.nodeType) return null;for (var t = D(e); !this.contains(t);) {
      for (; t.parentNode;) {
        t = t.parentNode;
      }if (!t.host) return null;t = t.host;
    }return t;
      ...
      R = document.getSelection;M(t.prototype, { adoptNode: function adoptNode(e) {
      ...
      W = e.wrappers.TreeWalker;if (t.prototype.createTreeWalker = function (e, t, n, r) {
    ...
    var I = document.registerElement;t.prototype.registerElement = function (t, n) {
      function r(e) {
      ...
      }if (!a) throw new Error("NotSupportedError");for (var u = Object.create(a), l = c.length - 1; l >= 0; l--) {
        u = Object.create(u);
      }["createdCallback", "attachedCallback", "detachedCallback", "attributeChangedCallback"].forEach(function (e) {
        var t = o[e];t && (u[e] = function () {
          D(this) instanceof r || N(this), t.apply(D(this), arguments);
        });
      });var p = { prototype: u };i && (p["extends"] = i), r.prototype = o, r.prototype.constructor = r, e.constructorTable.set(u, r), e.nativePrototypeTable.set(o, u);I.call(_(this), t, p);return r;
    }, E([window.HTMLDocument || window.Document], ["registerElement"]);
  }E([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement, window.HTMLHtmlElement], ["appendChild", "compareDocumentPosition", "contains", "getElementsByClassName", "getElementsByTagName", "getElementsByTagNameNS", "insertBefore", "querySelector", "querySelectorAll", "removeChild", "replaceChild"]), E([window.HTMLBodyElement, window.HTMLHeadElement, window.HTMLHtmlElement], S), E([window.HTMLDocument || window.Document], ["adoptNode", "importNode", "contains", "createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "createTreeWalker", "elementFromPoint", "getElementById", "getElementsByName", "getSelection"]), M(t.prototype, u), M(t.prototype, p), M(t.prototype, h), M(t.prototype, d), M(t.prototype, { get implementation() {
      var e = H.get(this);return e ? e : (e = new a(_(this).implementation), H.set(this, e), e);
    }, get defaultView() {
      return D(_(this).defaultView);
    } }), T(window.Document, t, document.implementation.createHTMLDocument("")), window.HTMLDocument && T(window.HTMLDocument, t), C([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement]);var A = document.implementation.createDocument;a.prototype.createDocument = function () {
  ...
  function t(e) {
    n.call(this, e);
      ...
      f = window.getSelection;t.prototype = Object.create(n.prototype), l.prototype.getComputedStyle = function (e, t) {
    ...
    l.prototype[e] = function () {
      var t = u(this || window);return t[e].apply(t, arguments);
    }, delete window[e];
